    ...
    <S.Root ref={dropdownRef}>
      ...
      <S.DropdownList isOpen={isOpen}>
        ...
        <Button1
          ...
          activeTransformScale={0.95}
        >
          <Text label="명" colorName={textColor} fontStyle="action-md" />
        </Button1>
        <Button1 {...ButtonPropPreset} onClick={() => handleItemClick("verb")}>
          <Text label="동" colorName={textColor} fontStyle="action-md" />
        </Button1>
        <Button1
          {...ButtonPropPreset}
          onClick={() => handleItemClick("adjective")}
        >
          <Text label="형" colorName={textColor} fontStyle="action-md" />
        </Button1>
        <Button1
          {...ButtonPropPreset}
          onClick={() => handleItemClick("adverb")}
        >
          <Text label="부" colorName={textColor} fontStyle="action-md" />
        </Button1>
      </S.DropdownList>
    </S.Root>
  );
